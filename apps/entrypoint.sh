...
if [ ! -f "/home/ansible/.ssh/id_rsa" ] || [ ! -f "/home/ansible/.ssh/id_rsa.pub" ]; then
    ...
    python3 -c "import pyfiglet; font = pyfiglet.figlet_format('Testrun', font='slant'); print(font); print('SSH keys are absent. Running on localhost powdered milk today!\n')"
else
